try {
    ...
    Publish-AzVMDscConfiguration -ConfigurationPath "$PSScriptRoot\dsc\AddSqlClusterNode.ps1" -OutputArchivePath "$PSScriptRoot\dsc\AddSqlClusterNode.ps1.zip" -Force
    ...
    Publish-AzVMDscConfiguration -ConfigurationPath "$PSScriptRoot\dsc\CreateSqlCluster.ps1" -OutputArchivePath "$PSScriptRoot\dsc\CreateSqlCluster.ps1.zip" -Force
}
finally {
